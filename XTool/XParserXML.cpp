...
//-----------------------------------------------------------------------------
XNodeXML* XNodeXML::GetNode(std::string nodename, uint32 num)
{
	if (nodename[0] != '/')
		return NULL;
...
//-----------------------------------------------------------------------------
bool XNodeXML::FindNode(std::string nodename, uint32 num)
{
	if (nodename[0] != '/')
		return false;
	int pos = nodename.find('/', 1);
...
// Lecture d'un noeud
//-----------------------------------------------------------------------------
std::string XNodeXML::ReadNode(std::string nodename, uint32 num)
{
	std::string result = "";
	if (nodename[0] != '/')
		return result;
...
//-----------------------------------------------------------------------------
uint32 XNodeXML::ReadArrayNode(std::string nodename, std::vector<std::string>* V)
{
	if (nodename[0] != '/')
		return 0;
	int pos = nodename.find('/', 1);
...
//-----------------------------------------------------------------------------
uint32 XNodeXML::ReadAllNodes(std::string nodename, std::vector<XNodeXML*>* T)
{
	if (nodename[0] != '/')
		return 0;
	int pos = nodename.find('/', 1);
...
// Recherche d'un noeud
//-----------------------------------------------------------------------------
bool XParserXML::FindNode(std::string nodename, uint32 num)
{
	if (m_Sub != NULL)
...
// Lecture d'un noeud
//-----------------------------------------------------------------------------
std::string XParserXML::ReadNode(std::string nodename, uint32 num)
{
	if (m_Sub != NULL)
...
//-----------------------------------------------------------------------------
int XParserXML::ReadNodeAsInt(std::string nodename, uint32 num)
{
...
uint32 XParserXML::ReadNodeAsUInt32(std::string nodename, uint32 num)
{
	if (!FindNode(nodename, num))
		return 0;
	std::string result = ReadNode(nodename, num);
...
double XParserXML::ReadNodeAsDouble(std::string nodename, uint32 num)
{
	if (!FindNode(nodename, num))
		return 0.;
	std::string result = ReadNode(nodename, num);
...
bool XParserXML::ReadNodeAsBool(std::string nodename, uint32 num)
{
...
// Lecture d'un tableau de noeuds
//-----------------------------------------------------------------------------
uint32 XParserXML::ReadArrayNode(std::string nodename, std::vector<std::string>* V)
{
	if (m_Sub != NULL)
...
//-----------------------------------------------------------------------------
uint32 XParserXML::ReadArrayNodeAsInt(std::string nodename, std::vector<int>* V)
{
...
uint32 XParserXML::ReadArrayNodeAsUInt32(std::string nodename, std::vector<uint32>* V)
{
	std::vector<std::string> T;
	ReadArrayNode(nodename, &T);
	uint32 x;
...
uint32 XParserXML::ReadArrayNodeAsDouble(std::string nodename, std::vector<double>* V)
{
	std::vector<std::string> T;
	ReadArrayNode(nodename, &T);
	double x;
...
//-----------------------------------------------------------------------------
XParserXML XParserXML::FindSubParser(std::string nodename, uint32 num)
{
	XParserXML P;
...
//-----------------------------------------------------------------------------
uint32 XParserXML::FindAllSubParsers(std::string nodename, std::vector<XParserXML>* T)
{
