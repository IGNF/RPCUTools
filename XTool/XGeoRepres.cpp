...
//-----------------------------------------------------------------------------
void XGeoRepres::Color(byte& r, byte& g, byte& b)
{
	byte* ptr = (byte*)&m_nColor;
...
//-----------------------------------------------------------------------------
void XGeoRepres::FillColor(byte& r, byte& g, byte& b)
{
	byte* ptr = (byte*)&m_nFillColor;
  r = ptr[2]; // Modification pour QT
	g = ptr[1];
  b = ptr[0];
}
...
//-----------------------------------------------------------------------------
bool XGeoRepres::XmlRead(XParserXML* parser, uint32 num, XError* error)
{
