...
public:
	...
	virtual uint32 NbPt() const { return 1;}
	virtual XPt2D Pt(uint32 i) { return XPt2D(m_Frame.Xmin, m_Frame.Ymax);}

	virtual std::string Name();
	virtual uint16 Importance();
	virtual uint16 Rotation() { return 0;}
...
public:
	...
	virtual double Z(uint32 i) { return m_Z;}
