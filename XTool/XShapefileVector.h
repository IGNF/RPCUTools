...
public :
	...
	inline uint32 Index() const { return m_nIndex;}
	void Shapefile(XShapefile* shapefile, uint32 index) { m_File = shapefile; m_nIndex = index;}
...
public:
	...
	uint32 ByteSize() const {return 20;}
...
public:
	...
	uint32 ByteSize() const {return 36;}
...
public:
	...
	uint32 ByteSize() const {return 36 + 16 * m_nNumPoints;}
...
public:
	...
	uint32 ByteSize() const {return 36 + 16 * m_nNumPoints + 16 + m_nNumPoints * 8; ;}
...
public:
	...
	uint32 ByteSize() const { return 44 + 4 * m_nNumParts + 16 * m_nNumPoints;}

	inline uint32 PosGeom() const { return m_Pos;}
	virtual inline XGeoMap* Map() const { return m_File;}
...
public:
	...
	uint32 ByteSize() const { return 44 + 4 * m_nNumParts + 16 * m_nNumPoints + 16 + m_nNumPoints * 8;}
