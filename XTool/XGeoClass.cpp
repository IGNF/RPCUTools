...
//-----------------------------------------------------------------------------
std::string XGeoAttribut::ShortName(uint32 num) const
{
...
//-----------------------------------------------------------------------------
bool XGeoAttribut::XmlRead(XParserXML* parser, uint32 num, XError* error)
{
...
//-----------------------------------------------------------------------------
std::string XGeoSchema::AttributName(uint32 i) const
{
	if (i >= m_Attrib.size())
		return " ";
...
//-----------------------------------------------------------------------------
std::string XGeoSchema::AttributShortName (uint32 i) const
{
	if (i >= m_Attrib.size())
		return " ";
...
//-----------------------------------------------------------------------------
XGeoAttribut::eType XGeoSchema::AttributType (uint32 i) const
{
	if (i >= m_Attrib.size())
...
//-----------------------------------------------------------------------------
uint32 XGeoSchema::AttributLength(uint32 i) const
{
	if (i >= m_Attrib.size())
		return 0;
...
//-----------------------------------------------------------------------------
uint32 XGeoSchema::AttributDecCount(uint32 i) const
{
	if (i >= m_Attrib.size())
		return 0;
...
//-----------------------------------------------------------------------------
std::string XGeoSchema::AttributTypeString(uint32 i) const
{
	if (i >= m_Attrib.size())
		return "";
...
bool XGeoSchema::AddAttribut(std::string name, std::string shortname, std::string desc,
														 XGeoAttribut::eType type, uint32 length, byte dec)
{
	XGeoAttribut attrib(name, shortname, desc, type, length, dec);
	for (uint32 i = 0; i < m_Attrib.size(); i++) {
...
//-----------------------------------------------------------------------------
bool XGeoSchema::XmlRead(XParserXML* parser, uint32 num, XError* error)
{
...
//-----------------------------------------------------------------------------
uint32 XGeoClass::Find(std::vector<XGeoVector*>* T, XPt2D& P, double dist)
{
	XGeoVector* vector;
	T->clear();
	for (uint32 i = 0; i < m_Vector.size(); i++) {
...
//-----------------------------------------------------------------------------
uint32 XGeoClass::FindConnection(std::vector<XGeoVector*>* T, XPt2D& P)
{
	XGeoVector* vector;
	T->clear();
	for (uint32 i = 0; i < m_Vector.size(); i++) {
...
// Import XML
//-----------------------------------------------------------------------------
bool XGeoClass::XmlRead(XParserXML* parser, uint32 num, XError* error)
{
