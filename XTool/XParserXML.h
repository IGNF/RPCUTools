...
public:
	...
	XNodeXML* GetNode(std::string nodename, uint32 num = 0);
	...
	bool FindNode(std::string nodename, uint32 num = 0);
	std::string ReadNode(std::string nodename, uint32 num = 0);
	uint32 ReadArrayNode(std::string nodename, std::vector<std::string>* V);
	uint32 ReadAllNodes(std::string nodename, std::vector<XNodeXML*>* T);
...
public:
  ...
  bool Parse(std::istream* stream);
	...
	bool FindNode(std::string nodename, uint32 num = 0);
	std::string ReadNode(std::string nodename, uint32 num = 0);
	int ReadNodeAsInt(std::string nodename, uint32 num = 0);
	uint32 ReadNodeAsUInt32(std::string nodename, uint32 num = 0);
	double ReadNodeAsDouble(std::string nodename, uint32 num = 0);
	bool ReadNodeAsBool(std::string nodename, uint32 num = 0);

	uint32 ReadArrayNode(std::string nodename, std::vector<std::string>* V);
	uint32 ReadArrayNodeAsInt(std::string nodename, std::vector<int>* V);
	uint32 ReadArrayNodeAsUInt32(std::string nodename, std::vector<uint32>* V);
	uint32 ReadArrayNodeAsDouble(std::string nodename, std::vector<double>* V);

	XParserXML FindSubParser(std::string nodename, uint32 num = 0);
	uint32 FindAllSubParsers(std::string nodename, std::vector<XParserXML>* T);
